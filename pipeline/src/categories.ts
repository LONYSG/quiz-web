...
export const MIDS: MidCategory[] = [
  // ───────────────────────────────────────────────────────── 한국
  {
    ...
    boundary:
      '★ 사건·제도·정책·유물을 해당 시대 소분류에 넣는다. ' +
      '문화유산을 따로 묶지 않는다 (훈민정음 문제는 "조선 전기" 다). ' +
      '★★ 인물 자체를 묻는 문제는 여기가 아니라 **그 인물이 활동한 분야 중분류**로 보낸다 (D-083) — 화가는 미술·화가, 과학자는 발명·발견, 문인은 문학, 음악가는 음악. ★ 단 그 인물이 **역사적 사건의 주체**일 때는 여기가 맡는다 (이순신의 해전은 사건이다).',
  },
  {
  ...
  // ───────────────────────────────────────────────────────── 인문·사회
  {
    ...
    boundary:
      '★ 초안의 "세계사" 를 셋으로 쪼갠 것이다. 전쟁 자체는 전쟁·군사사로 보낸다. ' +
      '★★ 인물 자체를 묻는 문제는 여기가 아니라 **그 인물이 활동한 분야 중분류**로 보낸다 (D-083) — 화가는 미술·화가, 과학자는 발명·발견, 문인은 문학, 음악가는 음악. ★ 단 그 인물이 **역사적 사건의 주체**일 때는 여기가 맡는다 (이순신의 해전은 사건이다).',
  },
  {
  ...
  // ───────────────────────────────────────────────────────── 문화·예술
  {
    ...
    subNotes: {
      '한국·동양 미술':
        '★★ 한국·동양의 화가와 그 작품을 여기가 맡는다. 시대 소분류가 맡지 않는다 (D-083) — ' +
        '조선 시대 화가도 여기다. ★ R017 에서 김홍도 문제가 "한국사 > 조선 후기" 에도 만들어져 중복이 났다.',
    },
  },
  {
