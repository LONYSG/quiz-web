  ...
  properties: {
    items: {
      ...
      items: {
        ...
        required: ['sourceRef', 'answer', 'ambiguous', 'alternatives', 'confidence'],
      },
    },
  },
  required: ['items'],
...
아래 질문들을 보고 각각의 정답을 맞혀라.

규칙
- 질문만 보고 답한다. 다른 정보는 주어지지 않는다
- 정답은 가장 표준적인 한국어 표기 하나로 답한다
- ★ 조건을 만족하는 답이 둘 이상 있으면 ambiguous=true 로 하고
  alternatives 에 가능한 답들을 넣는다. 이 판정이 이 작업의 핵심이다
