...
★★★ **R020: R019 결과 683건을 적재했다. 활성 문제 1,374건 / 297개 소분류 중 261개를 채웠다.**
★★ 함께 **표기 변형 결함 220건을 정리**했다 — 감사 `foreignVariant` 260 → **0**, 진짜 정답 노출 6 → **0**.
★ 규모 확장 2차로 **656건을 더 쌓았다.** 이 결과의 적재는 건우 승인 대기다 (C21).
★ **남은 소분류는 138개다** (297 − 159. R017 20 + R018 20 + R019 60 + R020 60, 겹침 1).
...
| 지표 | R017 (넓은 20) | R018 (좁은 20) | R019 (넓은 60) | **R020 (넓은 60 · 하한 없음)** |
|------|---------------|---------------|---------------|------------------------------|
| 나열한 후보 → 선택 | 564 → 200 (35.5%) | 544 → 194 (35.7%) | 1,606 → 720 (44.8%) | 1,535 → 685 (**44.6%**) |
| 요청 대비 생성 | 200 / 200 (100%) | 194 / 200 (97.0%) | 720 / 720 (100%) | ★ **685 / 720 (95.1%)** — 일부러 덜 만들었다 |
| 문제 생성 | 200 성공 / 거절 0 | 193 성공 / 거절 1 | 710 성공 / 거절 10 | 677 성공 / **거절 8** |
| 중복으로 격리 | 1 | 5 | 15 | **21** (라운드 안 9 + 판정 12) |
| **손실률** | 0.5% | 3.1% | 3.5% | **4.2%** |
| ★ 살아남은 문제 | **199** | **188** | **695** | **656** |
| 같은 소분류 안 정답 중복 | 0건 | 0건 | 0건 | **0건** |
| `acceptedAnswers` 빈 배열 | 89.0% | 91.5% | 90.4% | **76.1%** |
| 알 가치 1~2 | 0건 | 0건 | ★★ 12건 (1.7%) | ★★ **0건** |
| 난이도 평균 / 4 이상 | 3.04 / 29.0% | 3.24 / 40.4% | 2.64 / 15.8% | **2.91 / 21.2%** |
| 알 가치 평균 | 3.93 | 3.76 | 4.19 | ★★ **4.66** |
| 소분류당 소재 | 10.0 | 9.7 | 12.0 | ★ **11.4** (21개가 12 전에 멈췄다) |
