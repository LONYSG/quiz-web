...
★★★ **R018: 소재 기반 구조로 두 라운드를 돌렸다. 적재 가능 387건.**
★ DB 적재는 건우 승인 대기다.
...
★ 손실률은 실측 1.8%(394건 중 7건)를 3%로 보수적으로 잡았다 —
★★ 라운드가 쌓일수록 대조 대상이 늘어 중복 손실이 커지기 때문이다
(R017 0.5% → R018 3.1%).
